...
export const Sidebar: FC<Props> = ({
  ...
  return (
    <aside
      className={`fixed top-0 bottom-0 z-50 sm:pt-10 flex h-full w-[260px] flex-none flex-col space-y-2 bg-[#202123] p-2 transition-all sm:relative sm:top-0`}
    >
      ...
      <SidebarSettings
        ...
        onSystemSetting={onSystemSetting}
